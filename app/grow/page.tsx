          ...
          <div className="max-w-[1400px] mx-auto px-4 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="flex flex-col gap-6">
              <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/30 rounded-full px-4 py-1.5 w-fit shadow-sm">
                <span className="material-symbols-outlined text-accent text-sm animate-pulse" style={{ fontVariationSettings: "'FILL' 1" }}>diversity_3</span>
                <span className="text-xs font-bold uppercase tracking-wider text-accent">Full-Stack Growth Department</span>
              </div>
              ...
              <h1 className="font-heading text-4xl md:text-5xl lg:text-[3.5rem] font-extrabold text-foreground leading-[1.1] tracking-tight text-balance">
                Meet Spark Grow: Your <span className="text-secondary">In-House Team.</span>
              </h1>
            ...
            <HeroVisualFrame
              imageSrc="/images/solar-residential.png"
              altText="Spark Grow In-House Team Creative Visual Showcase"
              badgeText="Active"
              statsTitle="Creative Campaigns"
              statsValue="18 Active"
              toastIcon="draw"
              toastTitle="Creative Fuel Synced"
              toastBody="High-converting ad creatives deployed instantly"
              performanceLabel="Creative Sync"
              performanceValue="Automated"
            />
          </div>
        </section>
